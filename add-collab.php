		...
		/* $titre = $description = $date_debut = '';
		 ...
		 if($_SERVER['REQUEST_METHOD'] == 'POST'){
		 	if(empty($_POST['titre'])){
		 		$titre = '<span class="erreur">Le nom est requis !!</span>';
		 	}
		 	if(empty($_POST['description'])){
		 		$description = '<span class="erreur">Le prenom est requis !!</span>';
		 	}
		 	if(empty($_POST['date_debut'])){
				$date_debut = '<span class="erreur">Le DateNaissance est requis !!</span>';
			}
		 }*/
...
<ul class="side-menu">
	...
	<section id="content">
       ...
       <!-- <label for="id_collaboration">Id_Collab:</label>
        <input type="text" id="id_collaboration" name="id_collaboration" placeholder="id_collaboration"><br><br>-->
        ...
        <label for="contrat" class="custom-file-upload">
    <i class="fas fa-cloud-upload-alt"></i> Upload Contrat
    </label>
    <input type="file" id="contrat" name="contrat" style="display: none;">
