...
<div class="table-data" style="margin: auto; width: 50%; text-align: left;"> <!-- Centering the table and adjusting width -->
    ...
    <div class="container">
        ...
        <form action="" method="POST">
            <div class="mb-3">
            <input type="text" id="id_student" class="form-control" name="id_student" placeholder="ID Student" required>
                        </div>
                        <div class="mb-3">
                            <input type="text" id="to_stud" class="form-control" name="to_stud" placeholder="To" required>
                        </div>
                        <div class="mb-3">
                            <input type="text" id="name" class="form-control" name="name" placeholder="Name" required>
                        </div>
                        <div class="mb-3">
                            <input type="text" id="message" class="form-control" name="message" placeholder="Message" required>
                        </div>
                        <div class="mb-3">
                            <input type="text" id="answer" class="form-control" name="answer" placeholder="Answer" required>
                        </div>
                        <div class="mb-3">
                            <input type="date" id="date" class="form-control" name="date" min="<?php echo date('Y-m-d'); ?>" required>
                        </div>
