...
<img src="media\logobil3orth.png" alt="Logo" class="logo">
    <div class="container">
        ...
        <form action="" method="POST">
            <div class="mb-3">
            <input type="text" id="id_student" class="id_label" name="id_student" readonly value=<?= $row['id_student']; ?>>
            <label class="id_label" id="id_student_label">id student</label>
            </div>
            <div class="mb-3">
            <input type="text" id="stud_id_inp" class="id_label" name="to_stud" readonly value=<?= $row['to_stud']; ?>>
            <label class="to_stud_label" id="stud_id_label">to</label>
            </div>
            <div class="mb-3">
            <input type="text" id="name" class="id_label" name="name" value=<?= $row['name']; ?>>
            <label class="id_label" id="name_label">name</label>
            </div>
            <div class="mb-3">
            <input type="text" id="message_inp" class="id_label" name="message" value=<?= $row['message']; ?>>
            <label class="id_label" id="message_label">message</label>
            </div>
            <div class="mb-3">
            <input type="text" id="answer_inp" class="id_label" name="answer" value=<?= $row['answer']; ?>>
            <label class="id_label" id="answer_label">answer</label>
            </div>
            <div class="mb-3">
            <input type="date" id="date_inp" class="id_label" name="date" value=<?= $row['date']; ?>>
